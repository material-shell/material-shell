...
const hotKeysLabels = {
    ...
    'go-workspace-1': 'Navigate to workspace 1',
    'go-workspace-2': 'Navigate to workspace 2',
    'go-workspace-3': 'Navigate to workspace 3',
    'go-workspace-4': 'Navigate to workspace 4',
    'go-workspace-5': 'Navigate to workspace 5',
    'go-workspace-6': 'Navigate to workspace 6',
    'go-workspace-7': 'Navigate to workspace 7',
    ...
    'move-window-workspace-1': 'Move the current window to the workspace 1',
    'move-window-workspace-2': 'Move the current window to the workspace 2',
    'move-window-workspace-3': 'Move the current window to the workspace 3',
    'move-window-workspace-4': 'Move the current window to the workspace 4',
    'move-window-workspace-5': 'Move the current window to the workspace 5',
    'move-window-workspace-6': 'Move the current window to the workspace 6',
    'move-window-workspace-7': 'Move the current window to the workspace 7',
    'cycle-tiling-layout':
