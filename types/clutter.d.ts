...
export function cairo_clear(cr: any): void;

export function cairo_set_source_color(cr: any, color: Color): void;
...
export function get_font_map(): any;
...
export type BindingActionFunc<A = GObject.Object> = (gobject: A, action_name: string, key_val: number, modifiers: ModifierType) => boolean;
...
export type ProgressFunc = (a: any, b: any, progress: number, retval: any) => boolean;

export type ScriptConnectFunc<A = GObject.Object, B = GObject.Object> = (script: Script, object: A, signal_name: string, handler_name: string, connect_object: B, flags: GObject.ConnectFlags) => void;
...
export module Actor {
    export interface ConstructorProperties<A = LayoutManager, B = Content> extends GObject.InitiallyUnowned.ConstructorProperties {
        [key: string]: any;
        actions: Action;
        allocation: ActorBox;
...
export class Actor<A = LayoutManager, B = Content> extends GObject.InitiallyUnowned implements Atk.ImplementorIface, Animatable, Container<Actor>, Scriptable {
    ...
    connect_after(signal: 'queue-redraw', callback: (_source: this, origin: Actor, volume: PaintVolume) => boolean): number;
    ...
    apply_relative_transform_to_point(ancestor: Actor | null, point: any): any;
    ...
    create_pango_layout(text?: string | null): any;
    destroy(): void;
...
export class Canvas extends GObject.Object implements Content {
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number;
    emit(id: string, ...args: any[]): void;
    connect(signal: 'draw', callback: (_source: this, cr: any, width: number, height: number) => boolean): number;
    connect_after(signal: 'draw', callback: (_source: this, cr: any, width: number, height: number) => boolean): number;
    emit(signal: 'draw', cr: any, width: number, height: number): void;
    // Members
...
export class Clone<A extends Actor = Actor> extends Actor implements Atk.ImplementorIface, Animatable, Container<A>, Scriptable {
...
export class FrameClock extends GObject.Object {
    ...
    emit(signal: 'destroy'): void;
    // Constructors
    static ["new"](refresh_rate: number, iface: FrameListenerIface, user_data?: any | null): FrameClock;
    // Members
...
export class Image extends GObject.Object implements Content {
    ...
    set_area(data: Uint8Array | string, pixel_format: Cogl.PixelFormat, rect: any, row_stride: number): boolean;
...
export class InputDevice extends GObject.Object {
    ...
    get_coords(sequence: EventSequence | null): [boolean, any];
...
export abstract class InputMethod extends GObject.Object {
    ...
    connect(signal: 'cursor-location-changed', callback: (_source: this, object: any) => void): number;
    connect_after(signal: 'cursor-location-changed', callback: (_source: this, object: any) => void): number;
    emit(signal: 'cursor-location-changed', object: any): void;
...
export class LayerNode extends PaintNode {
    ...
    // Constructors
    static ["new"](projection: Cogl.Matrix, viewport: any, width: number, height: number, opacity: number): LayerNode;
}
...
export class ScrollActor<A extends Actor = Actor> extends Actor implements Atk.ImplementorIface, Animatable, Container<A>, Scriptable {
...
export abstract class Seat extends GObject.Object {
    ...
    connect(signal: 'tool-changed', callback: (_source: this, object: InputDevice, p0: InputDeviceTool) => void): number;
    connect_after(signal: 'tool-changed', callback: (_source: this, object: InputDevice, p0: InputDeviceTool) => void): number;
...
export class Stage<A extends Actor = Actor> extends Actor implements Atk.ImplementorIface, Animatable, Container<A>, Scriptable {
    ...
    connect(signal: 'paint-view', callback: (_source: this, view: StageView, redraw_clip: any) => void): number;
    connect_after(signal: 'paint-view', callback: (_source: this, view: StageView, redraw_clip: any) => void): number;
    emit(signal: 'paint-view', view: StageView, redraw_clip: any): void;
    ...
    // Members
    capture_into(paint: boolean, rect: any, data: number): void;
    ...
    get_capture_final_size(rect: any, width: number, height: number, scale: number): boolean;
    ...
    paint_to_buffer(rect: any, scale: number, data: number, stride: number, format: Cogl.PixelFormat, paint_flags: PaintFlag): boolean;
...
export class Text<A extends Actor = Actor> extends Actor implements Atk.ImplementorIface, Animatable, Container<A>, Scriptable {
    ...
    connect(signal: 'cursor-event', callback: (_source: this, rect: any) => void): number;
    connect_after(signal: 'cursor-event', callback: (_source: this, rect: any) => void): number;
    emit(signal: 'cursor-event', rect: any): void;
    ...
    set_attributes(attrs?: any | null): void;
    ...
    set_font_description(font_desc: any): void;
    ...
    set_line_alignment(alignment: any): void;
    ...
    set_preedit_string(preedit_str: string | null, preedit_attrs: any | null, cursor_pos: number): void;
...
export class TextNode extends PaintNode {
    ...
    // Constructors
    static ["new"](layout?: any | null, color?: Color | null): TextNode;
}
...
export class Timeline extends GObject.Object implements Scriptable {
    ...
    get_cubic_bezier_progress(): [boolean, any, any];
...
export class ZoomAction extends GestureAction {
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number;
    emit(id: string, ...args: any[]): void;
    connect(signal: 'zoom', callback: (_source: this, actor: Actor, focal_point: any, factor: number) => boolean): number;
    connect_after(signal: 'zoom', callback: (_source: this, actor: Actor, focal_point: any, factor: number) => boolean): number;
    emit(signal: 'zoom', actor: Actor, focal_point: any, factor: number): void;
    // Constructors
    static ["new"](): ZoomAction;
    // Members
    get_focal_point(): any;
    get_transformed_focal_point(): any;
    get_zoom_axis(): ZoomAxis;
    set_zoom_axis(axis: ZoomAxis): void;
    vfunc_zoom(actor: Actor, focal_point: any, factor: number): boolean;
}
