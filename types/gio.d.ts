...
export function app_info_launch_default_for_uri_async(uri: string, context?: AppLaunchContext | null, cancellable?: Cancellable | null, callback?: AsyncReadyCallback<string> | null): void;
...
export function async_initable_newv_async(object_type: GObject.GType, n_parameters: number, parameters: GObject.Parameter, io_priority: number, cancellable?: Cancellable | null, callback?: AsyncReadyCallback<GObject.GType> | null): void;

export function bus_get(bus_type: BusType, cancellable?: Cancellable | null, callback?: AsyncReadyCallback<BusType> | null): void;
...
export function dbus_address_get_stream(address: string, cancellable?: Cancellable | null, callback?: AsyncReadyCallback<string> | null): void;
...
export function initable_newv<T = GObject.Object>(object_type: GObject.GType, parameters: GObject.Parameter[], cancellable?: Cancellable | null): T;

export function io_error_from_errno(err_no: number): IOErrorEnum;

export function io_error_quark(): GLib.Quark;

export function io_extension_point_implement(extension_point_name: string, type: GObject.GType, extension_name: string, priority: number): IOExtension;
...
export function simple_async_report_gerror_in_idle(object: GObject.Object | null, callback: AsyncReadyCallback<(GObject.Object | null)> | null, error: GLib.Error): void;
...
export type DBusProxyTypeFunc = (manager: DBusObjectManagerClient, object_path: string, interface_name?: string | null) => GObject.GType;
...
export type SimpleAsyncThreadFunc<A = GObject.Object> = (res: SimpleAsyncResult, object: A, cancellable?: Cancellable | null) => void;

export type SocketSourceFunc = (socket: Socket, condition: GLib.IOCondition) => boolean;

export type TaskThreadFunc<A = GObject.Object> = (task: Task, source_object: A, task_data?: any | null, cancellable?: Cancellable | null) => void;
...
export class DBusError extends GLib.Error {
    ...
    static register_error_domain(error_domain_quark_name: string, quark_volatile: number, entries: DBusErrorEntry[]): void;
    static set_dbus_error(error: GLib.Error, dbus_error_name: string, dbus_error_message: string, format: string | null, ___: any[]): void;
    static set_dbus_error_valist(error: GLib.Error, dbus_error_name: string, dbus_error_message: string, format: string | null, var_args: any): void;
...
export class CharsetConverter extends GObject.Object implements Converter, Initable {
    ...
    reset(): void;
    vfunc_convert(inbuf: Uint8Array | null, outbuf: Uint8Array | null, flags: ConverterFlags): [ConverterResult, number, number];
    vfunc_reset(): void;
...
export class DBusConnection extends GObject.Object implements AsyncInitable<DBusConnection>, Initable {
    ...
    is_closed(): boolean;
    register_object(object_path: string, interface_info: DBusInterfaceInfo, vtable?: DBusInterfaceVTable | null, user_data?: any | null): number;
    ...
    send_message_with_reply(message: DBusMessage, flags: DBusSendMessageFlags, timeout_msec: number, cancellable?: Cancellable | null, callback?: AsyncReadyCallback<this> | null): number | null;
...
export class DBusObjectManagerClient extends GObject.Object implements AsyncInitable<DBusObjectManagerClient>, DBusObjectManager, Initable {
...
export module ListStore {
    export interface ConstructorProperties<A extends GObject.Object = GObject.Object> extends GObject.Object.ConstructorProperties {
        [key: string]: any;
...
export abstract class TlsDatabase extends GObject.Object {
    ...
    vfunc_lookup_certificates_issued_by(issuer_raw_dn: Uint8Array | string, interaction: TlsInteraction | null, flags: TlsDatabaseLookupFlags, cancellable?: Cancellable | null): TlsCertificate[];
    vfunc_lookup_certificates_issued_by_async(issuer_raw_dn: Uint8Array | string, interaction: TlsInteraction | null, flags: TlsDatabaseLookupFlags, cancellable?: Cancellable | null, callback?: AsyncReadyCallback<this> | null): void;
