...
export function hash_table_lookup_extended(hash_table: HashTable<any, any>, lookup_key?: any | null): [boolean, any | null, any | null];
...
export function hash_table_steal_extended(hash_table: HashTable<any, any>, lookup_key?: any | null): [boolean, any | null, any | null];
...
export function unix_fd_add_full(priority: number, fd: number, condition: IOCondition, _function: UnixFDSourceFunc): number;
...
export class Variant<A extends string = any> {
    ...
    static new_from_data(type: VariantType, data: Uint8Array | string, trusted: boolean, user_data?: any | null): Variant;
