...
export function form_decode_multipart(msg: Message, file_control_name?: string | null): [GLib.HashTable<string, string> | null, string | null, string | null, Buffer | null];
...
export function form_request_new_from_hash(method: string, uri: string, form_data_set: GLib.HashTable<string, string>): Message;
...
export function websocket_client_verify_handshake_with_extensions(msg: Message, supported_extensions?: GObject.TypeClass[] | null): [boolean, WebsocketExtension[] | null];
...
export function websocket_server_process_handshake_with_extensions(msg: Message, expected_origin?: string | null, protocols?: string[] | null, supported_extensions?: GObject.TypeClass[] | null): [boolean, WebsocketExtension[] | null];
...
export type AuthDomainBasicAuthCallback = (domain: AuthDomainBasic, msg: Message, username: string, password: string) => boolean;
...
export type PasswordManagerCallback = (password_manager: PasswordManager, msg: Message, auth: Auth, retrying: boolean) => void;
...
export type ServerCallback = (server: Server, msg: Message, path: string, query: GLib.HashTable<string, string> | null, client: ClientContext) => void;

export type ServerWebsocketCallback = (server: Server, connection: WebsocketConnection, path: string, client: ClientContext) => void;

export type SessionCallback = (session: Session, msg: Message) => void;

export type SessionConnectProgressCallback = (session: Session, event: Gio.SocketClientEvent, connection: Gio.IOStream) => void;
...
export class Socket extends GObject.Object implements Gio.Initable {
    ...
    read_until(buffer: Uint8Array | string, boundary: any | null, boundary_len: number, got_boundary: boolean, cancellable?: Gio.Cancellable | null): [SocketIOStatus, number];
