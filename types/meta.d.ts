...
export function prefs_get_titlebar_font(): any;
...
export class Background extends GObject.Object {
    ...
    // Members
    set_blend(file1: Gio.File, file2: Gio.File, blend_factor: number, style: any): void;
    set_color(color: Clutter.Color): void;
    set_file(file: Gio.File | null, style: any): void;
...
export module BackgroundActor {
    export interface ConstructorProperties<A extends Clutter.Actor = Clutter.Actor> extends Clutter.Actor.ConstructorProperties {
        [key: string]: any;
        meta_display: Display;
        monitor: number;
    }
}
export class BackgroundActor<A extends Clutter.Actor = Clutter.Actor> extends Clutter.Actor implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container<A>, Clutter.Scriptable {
...
export class BackgroundGroup<A extends Clutter.Actor = Clutter.Actor> extends Clutter.Actor implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container<A>, Clutter.Scriptable {
...
export class Display extends GObject.Object {
    ...
    connect(signal: 'grab-op-begin', callback: (_source: this, object: Display, p0: Window, p1: GrabOp) => void): number;
    connect_after(signal: 'grab-op-begin', callback: (_source: this, object: Display, p0: Window, p1: GrabOp) => void): number;
    ...
    connect_after(signal: 'grab-op-end', callback: (_source: this, object: Display, p0: Window, p1: GrabOp) => void): number;
...
export module Stage {
    export interface ConstructorProperties<A extends Clutter.Actor = Clutter.Actor> extends Clutter.Stage.ConstructorProperties {
        [key: string]: any;
    }
}
export class Stage<A extends Clutter.Actor = Clutter.Actor> extends Clutter.Stage implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container<A>, Clutter.Scriptable {
...
export abstract class WindowActor<A extends Clutter.Actor = Clutter.Actor> extends Clutter.Actor implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container<A>, Clutter.Scriptable {
...
export class WindowGroup<A extends Clutter.Actor = Clutter.Actor> extends Clutter.Actor implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container<A>, Clutter.Scriptable {
