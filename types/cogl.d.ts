...
export function texture_new_from_data(width: number, height: number, flags: TextureFlags, format: PixelFormat, internal_format: PixelFormat, rowstride: number, data: Uint8Array | string): Texture;
...
export class Offscreen extends Object implements Framebuffer {
    ...
    push_region_clip(region: any): void;
...
export class Matrix {
    ...
    init_from_euler(euler: any): void;
    init_identity(): void;
