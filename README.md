...
If you have some weird behavior or a degradation in time . It can be a good idea to try to reset the Material Shell state.
...
```
# History
The project is based upon my earlier work on [Material Awesome](https://github.com/PapyElGringo/material-awesome).
